...
class Dataset:
    ...
    def compute_ap_topn(self, rank_list, i, n):
        if n == 1:
            if rank_list[0].split('_')[0] == self.q_names[i].split('_')[0]:
                ap_topn = 1.0
            else:
                ap_topn = 0.0
        else:
            ...
            for i in range(len(rank_list)):
                if rank_list[i].split('_')[0] == self.q_names[i].split('_')[0]:
                    intersect_size += 1
...
if __name__ == '__main__':
    ...
    # Patch1
    # index_path = '/data/share/ImageRetrieve/lab20/index1'
    # query_path = '/data/share/ImageRetrieve/lab20/test0'

    # Patch2
    index_path = '../region_attention/datasets/patch2/index2'
    query_path = '../region_attention/datasets/patch2/test2'
